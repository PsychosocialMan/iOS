...
class IphonesModel {
    ...
    init() {
        let iphone6 = IphoneInfo(id: 1, price: 500, currency: Currency.EUR, specifications: "32GB", name: "Iphone 6", phoneImage: #imageLiteral(resourceName: "iphone6"))
        let iphone6s = IphoneInfo(id: 2, price: 550, currency: Currency.USD, specifications: "32GB", name: "Iphone 6S", phoneImage: #imageLiteral(resourceName: "iphone6s"))
        let iphone8plus = IphoneInfo(id: 3, price: 70000, currency: Currency.RUR, specifications: "64GB", name: "Iphone 8 Plus", phoneImage: #imageLiteral(resourceName: "iphone8plus"))
